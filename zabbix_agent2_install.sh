...
function repo22 {
  wget -q https://repo.zabbix.com/zabbix/6.5/ubuntu/pool/main/z/zabbix-release/zabbix-release_6.5-1+ubuntu22.04_all.deb
  dpkg -i zabbix-release_6.5-1+ubuntu22.04_all.deb > /dev/null
  echo "Imported the Zabbix 7.0 Pre-Release repository."
}

function repo20 {
  wget -q https://repo.zabbix.com/zabbix/6.5/ubuntu/pool/main/z/zabbix-release/zabbix-release_6.5-1+ubuntu20.04_all.deb
